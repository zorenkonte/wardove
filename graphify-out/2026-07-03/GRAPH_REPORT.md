# Graph Report - wardove  (2026-07-03)

## Corpus Check
- 114 files · ~60,739 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1075 nodes · 1470 edges · 100 communities (72 shown, 28 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 91 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b356e8d3`
...
1. `WardoveNavHost()` - 22 edges
2. `AddItemViewModel` - 21 edges
...
Cohesion: 0.07
Nodes (37): Modifier, String, Color, Modifier, List, String, T, Boolean (+29 more)
...
Cohesion: 0.23
Nodes (8): ClothingItem, List, StateFlow, String, WardrobeViewMode, WardrobeFilter, WardrobeSort, WardrobeViewModel
...
## Knowledge Gaps
- **354 isolated node(s):** `SettingsRepository`, `LockViewModel`, `SensorManager`, `Sensor`, `Bundle` (+349 more)
...
- **Why does `WardoveNavHost()` connect `Wardrobe Screen UI` to `Community 96`, `Settings UI & Navigation`, `Community 97`, `Community 99`, `Community 98`, `App Update Screen`, `App Entry & Theme`, `Stats & Analytics UI`, `Laundry Screen UI`, `Add Item Screen`, `Item Detail Screen`, `Community 90`, `Community 92`, `Community 93`, `Community 94`, `Community 95`?**
  _High betweenness centrality (0.126) - this node is a cross-community bridge._
- **Why does `AppLockSettingsViewModel` connect `Community 95` to `Image Storage`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `AppLockSettingsScreen()` connect `Community 95` to `Community 99`, `App Entry & Theme`, `Wardrobe Screen UI`?**
