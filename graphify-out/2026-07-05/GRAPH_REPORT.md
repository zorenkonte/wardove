...
## Corpus Check
- 116 files · ~56,044 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1063 nodes · 1432 edges · 109 communities (76 shown, 33 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 79 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c43ab7e5`
...
- `DayCell()` --calls--> `Dot()`  [INFERRED]
  app/src/main/java/com/app/wardove/ui/calendar/CalendarScreen.kt → app/src/main/java/com/app/wardove/ui/components/Dot.kt
- `WornItemCard()` --calls--> `ClothingImage()`  [INFERRED]
  app/src/main/java/com/app/wardove/ui/calendar/CalendarScreen.kt → app/src/main/java/com/app/wardove/ui/components/ClothingImage.kt
...
Cohesion: 0.08
Nodes (38): AddItemScreen(), CategoryDropdown(), ColorGrid(), ImagePicker(), ShareItemSheet(), AddItemViewModel, Modifier, String (+30 more)
...
Cohesion: 0.11
Nodes (27): Boolean, ClothingItem, Color, List, Long, Modifier, String, WearLog (+19 more)
...
Cohesion: 0.16
Nodes (18): Boolean, ClothingItem, Int, LocalDate, Set, Modifier, String, adjustSelection() (+10 more)
...
## Knowledge Gaps
- **368 isolated node(s):** `AddItemViewModel`, `Uri`, `ShareItemViewModel`, `SettingsRepository`, `LockViewModel` (+363 more)
...
- **What connects `AddItemViewModel`, `Uri`, `ShareItemViewModel` to the rest of the system?**
